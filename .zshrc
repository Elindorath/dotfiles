...
export ZSH=/Users/elindorath/.oh-my-zsh
...
plugins=(git git-flow-completion docker docker-compose)
...
alias drmall='docker ps -a | grep "ago" | awk '"'"'{print $1}'"'"' | xargs docker rm'
alias drmiall='docker images | grep "ago" | awk '"'"'{print $3}'"'"' | xargs docker rmi'
if ! docker-machine ls | grep "Running" > /dev/null; then
  docker-machine start default;
fi

if ! env | grep -q ^DOCKER_HOST=; then
